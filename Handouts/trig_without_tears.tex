...
\vspace{5mm}
\noindent The arc-functions have limitations on their ranges, so they can be functions. Let's take $\arcsin(\alpha)$, for example. If you wanted $\arcsin(\frac{1}{2})$, what angle would you get back? $30\deg$ or $150\deg$? To get only one value, we restrict the range of $\arcsin$ to be $[-\frac{\pi}{2},\frac{\pi}{2}]$
